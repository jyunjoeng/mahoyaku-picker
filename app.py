...
def _ranked_leaders_dataframe(
    ...
    for entry in sorted(
        ...
        rows.append(
            {
                "ランク": entry["rank"],
                "覚醒名": value_or_empty(leader, "覚醒名"),
                "キャラ": value_or_empty(leader, "キャラ"),
                "タイプ": value_or_empty(leader, "キャラタイプ"),
                "要求金1": value_or_empty(leader, "要求特性G1"),
                "要求金2": value_or_empty(leader, "要求特性G2"),
                "要求金3": value_or_empty(leader, "要求特性G3"),
                "要求銀1": value_or_empty(leader, "要求特性S1"),
                "要求銀2": value_or_empty(leader, "要求特性S2"),
                "要求銅": value_or_empty(leader, "要求特性B"),
                "要求無": value_or_empty(leader, "要求特性N"),
                "成長金": value_or_empty(leader, "成長特性G"),
                "拒否金": value_or_empty(leader, "拒否特性G"),
                "拒否銀": value_or_empty(leader, "拒否特性S"),
                "拒否銅": value_or_empty(leader, "拒否特性B"),
                "拒否無": value_or_empty(leader, "拒否特性N"),
            }
        )
